...
$(function () {
    ...
    const $container = $(`<div name="container" style="display: grid; grid-template-columns: 1fr 1fr;width: 30vw; height: 10vh"></div>`)
        .appendTo( $(`<div style="width: 100%; height: 100%; display: flex; justify-content: center;align-items: center"></div>`)
            ...
            const $test = $(`<div style="width:1500px; height:200px; background-color:red">Устная передача — самый древний способ передачи знаний в истории человечества. После изобретения древними цивилизациями систем записи люди начали использовать для письма почти всё, на чём можно писать — глиняные таблички, кору дерева, листы металла и т. п.
            Таблички
            ...
            Ксилография и инкунабулы</div>`).appendTo('body');
